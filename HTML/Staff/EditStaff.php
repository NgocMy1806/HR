...
$sqlDept = 'SELECT deptname FROM departments';
$statementDept = $pdo->query($sqlDept);
$Depts = $statementDept->fetchAll(PDO::FETCH_ASSOC);

$sqlRole = 'SELECT rolename FROM roles';
$statementRole = $pdo->query($sqlRole);
$Roles = $statementRole->fetchAll(PDO::FETCH_ASSOC);
?>

còn cần lấy ra status vs role nữa
        ...
        <div class=" content_area">
            ...
            <div class="formadd" >
                <form action="" method="post"> 
                    <h2 class="modal_title">Edit staff</h2>
                        <hr>
                    ...
                    <select class="long_field" id="status" name="status" required>
                    ...
                    <select class="long_field" id="dept" name="dept" required value="<?php echo $Staff['deptname'] ?>">
                     <br>
                     <select class="long_field" id="dept" name="dept" required>
                        <option value="" disabled selected>Choose department</option>
                        <option value="1">Depvelopement</option>
                    ...
                    <select class="long_field" id="role" name="role" required value="<?php echo $Staff['rolename'] ?>">
                       <br>
                       <select class="long_field" id="role" name="role" required>
                    ...
                    <select  class="long_field" id="role" name="role" required>
                <option value="<?php echo $Staff['rolename'] ?>"><?php echo $Staff['rolename'] ?></option>
                <?php
